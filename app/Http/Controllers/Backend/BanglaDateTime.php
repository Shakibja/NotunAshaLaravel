...
class BanglaDateTime extends Controller
{
    // Numbers
    ...
    public static function bn_date_time($date_time)
    {
        ...
        $date_time_bangla = str_replace(self::$en_times_uppercase, self::$bn_times, $date_time);

        // return $date_time;
        return view('backend.pages.postnews.manage', compact('date_time_bangla'));
    }
}
