<footer class="br-footer">
        <div class="footer-left">
          <div class="mg-b-2">Copyright &copy; 2023. <a href="https://www.techsolutionsbd.com">Techsolutions</a>. All Rights Reserved.</div>
          <div>Attentively and carefully made by <a href="https://www.asadimran.info">Asadullah Al Imran</a>.</div>
        </div>
...
<script>
    jQuery(function($) {
        ...
        $("body").on("change", ".image1", function(){
            var imageReader = new FileReader();
            imageReader.readAsDataURL(document.querySelector(".image1").files[0]);
...
<script>
    jQuery(function($) {
        ...
        $('#previewimage2').imgAreaSelect({
            onSelectEnd: function(img, selection) {
                $('input[name="top2"]').val(selection.y1);
                $('input[name="left2"]').val(selection.x1);
                $('input[name="height2"]').val(selection.height);
                $('input[name="width2"]').val(selection.width);
            }
        });
    });
</script>
