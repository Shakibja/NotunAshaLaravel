          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <ul class="list-unstyled user-profile-nav">
                {{-- <li><a class="text-decoration-none" href=""><i class="icon ion-ios-person"></i> Edit Profile</a></li> --}}
                {{-- <li><a class="text-decoration-none" href=""><i class="icon ion-ios-gear"></i> Settings</a></li> --}}
                ...
                <li style="">
                  <form action="{{ route('logout') }}" method="post">
                    @csrf
                    <button style="cursor: pointer; border: none; background: none; margin: 10px 0px 0px 5px;"><i class="icon ion-power"></i> Sign Out</button>
                  </form>
                </li>
              </ul>
            </div><!-- dropdown-menu -->
