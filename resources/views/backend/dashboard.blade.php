...
<div class="br-mainpanel">
  <div class="br-pagetitle">
    ...
    $toal_news = PostNews::count();
    $toal_published_news = PostNews::where('news_status', 'true')->count();
    $toal_draft_news = PostNews::where('news_status', 'false')->count();

    $toal_videos = Multimedia::count();
    // $toal_videos = Multimedia::where('video_status','false')->count();
    ...
    $weeklyVisitors = DB::table('visitors')
      ->whereDate('visited_at', '>=', $oneWeekAgo)
      ->count();
    ...
    $monthlyVisitors = DB::table('visitors')
      ->whereBetween('visited_at', [$firstDayOfMonth, $lastDayOfMonth])
      ->count();
    ...
    for ($day = 1; $day <= $daysInMonth; $day++) {
      $date = Carbon::createFromDate(null, null, $day)->toDateString();
      $count = DB::table('visitors')
        ->whereDate('visited_at', $date)
        ->count();
      $visitorsBreakdown[$date] = $count;

      // return view('backend.dashboard', ['visitorsBreakdown' => $visitorsBreakdown]);
    }
    ?>
  </div>
  ...
  <div class="br-pagebody">
    <div class="row row-sm">
      <div class="col-md-10 offset-md-1 text-center">
        <img src="{{asset('frontend')}}/images/Notun_Asha_Logo.png" alt="Notun Asha Logo" class="mb-5 w-50 img-fluid">
      </div>
    </div>
    ...
    <div class="row row-sm mb-5">
      <div class="col-sm-12">
        <canvas id="visitorsChart" height="2"></canvas>
      </div>
    </div>
      ...
      <div class="col-sm-6 col-xl-3">
        <div class="bg-info rounded overflow-hidden">
          <div class="pd-x-20 pd-t-20 d-flex align-items-center">
            ...
            <div class="mg-l-20">
              <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Total Newses</p>
              <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $toal_news}}</p>
            </div>
          </div>
      ...
      <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
        <div class="bg-purple rounded overflow-hidden">
          <div class="pd-x-20 pd-t-20 d-flex align-items-center">
            ...
            <div class="mg-l-20">
              <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Published</p>
              <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $toal_published_news }}</p>
            </div>
          </div>
      ...
      <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
        <div class="bg-teal rounded overflow-hidden">
          <div class="pd-x-20 pd-t-20 d-flex align-items-center">
            ...
            <div class="mg-l-20">
              <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Drafted</p>
              <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $toal_draft_news }}</p>
            </div>
          </div>
      ...
      <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
        <div class="bg-primary rounded overflow-hidden">
          <div class="pd-x-20 pd-t-20 d-flex align-items-center">
            ...
            <div class="mg-l-20">
              <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Total Videos</p>
              <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $toal_videos }}</p>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="bg-teal rounded overflow-hidden">
              <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                <i class="ion ion-earth tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Total Visitors</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $totalVisitors}}</p>
  </div>
</div>
<div id="ch1" class="ht-50 tr-y-1"></div>
</div>
...
<div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
  <div class="bg-primary rounded overflow-hidden">
    <div class="pd-x-20 pd-t-20 d-flex align-items-center">
      <i class="ion ion-bag tx-60 lh-0 tx-white op-7"></i>
      <div class="mg-l-20">
        <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Today's Visitors</p>
        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $todayVisitors }}</p>
      </div>
    </div>
    <div id="ch3" class="ht-50 tr-y-1"></div>
  </div>
...
<div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
  <div class="bg-info rounded overflow-hidden">
    <div class="pd-x-20 pd-t-20 d-flex align-items-center">
      <i class="ion ion-monitor tx-60 lh-0 tx-white op-7"></i>
      <div class="mg-l-20">
        <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Weekly Visitors</p>
        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $weeklyVisitors }}</p>
      </div>
    </div>
    <div id="ch2" class="ht-50 tr-y-1"></div>
  </div>
...
<div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
  <div class="bg-purple rounded overflow-hidden">
    <div class="pd-x-20 pd-t-20 d-flex align-items-center">
      <i class="ion ion-clock tx-60 lh-0 tx-white op-7"></i>
      <div class="mg-l-20">
        <p class="tx-14 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Montly Visitors</p>
        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">{{ $monthlyVisitors }}</p>
      </div>
    </div>
    <div id="ch4" class="ht-50 tr-y-1"></div>
  </div>
...
<script>
  ...
  var visitorsChart = new Chart(ctx, {
    ...
    data: {
      labels: {
        !!json_encode(array_keys($visitorsBreakdown)) !!
      },
      datasets: [{
        label: 'Visitors',
        data: {
          !!json_encode(array_values($visitorsBreakdown)) !!
        },
    ...
    options: {
      ...
      scales: {
        y: {
          beginAtZero: true,
          ticks: {
            // Ensure only integers are used on the y-axis
            callback: function(value) {
              if (Math.floor(value) === value) {
                return value;
              }
            },
            stepSize: 5 // This ensures steps of 1 between values
          }
        },
        x: {
          ticks: {
