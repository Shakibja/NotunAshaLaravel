...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-sm-12  col-12">
            ...
            <div class="w3-border w3-margin-bottom" id="e-paper" style="position: relative; overflow-y: scroll"> <span><a><img src="{{ asset('backend/images/e-paper-page/' . $page->page_image) }}" style="width: 850px"></a></span>
            ...
            @elseif ($page->page_number == '2')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',1)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="{{route('page',3)}}" class="w3-button w3-right w3-green">পরের পাতা &#10095;</a>
            </div>

            @elseif ($page->page_number == '3')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',2)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="{{route('page',4)}}" class="w3-button w3-right w3-green">পরের পাতা &#10095;</a>
            </div>

            @elseif ($page->page_number == '4')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',3)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="{{route('page',5)}}" class="w3-button w3-right w3-green">পরের পাতা &#10095;</a>
            </div>

            @elseif ($page->page_number == '5')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',4)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="{{route('page',6)}}" class="w3-button w3-right w3-green">পরের পাতা &#10095;</a>
            </div>

            @elseif ($page->page_number == '6')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',5)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="{{route('page',7)}}" class="w3-button w3-right w3-green">পরের পাতা &#10095;</a>
            </div>

            @elseif ($page->page_number == '7')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',6)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="{{route('page',8)}}" class="w3-button w3-right w3-green">পরের পাতা &#10095;</a>
            </div>

            @elseif ($page->page_number == '8')
            <div class="w3-bar w3-margin-bottom">
                <a href="{{route('page',7)}}" class="w3-button w3-green w3-green">&#10094; আগের পাতা</a>
                <a href="#" class="w3-button w3-right w3-disabled">পরের পাতা &#10095;</a>
            </div>
        ...
        <div class="col-md-4 col-sm-12 col-12">
           <div class="w3-container w3-light-gray mt-3">
                ...
                <form action="{{route('page', ['date' => $e_pap->date, 'page_number' => $e_pap->page_number])}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="w3-row">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Date : </label>
                            <input type="date" name="date" class="form-control"  value="" placeholder="dd/mm/yyyy">
                        </div>
                    </div>
