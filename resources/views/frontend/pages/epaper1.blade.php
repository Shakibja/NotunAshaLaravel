...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-9 col-sm-12 col-12">
            ...
            <div class="w3-border w3-margin-bottom" id="e-paper" style="position: relative; overflow-y: scroll"> <span><a><img src="{{ asset('backend/images/e-paper-page/' . $e_paper1[0]['page_image']) }}" style="width: 1150px"></a></span>
            ...
            <div id="{{ $item->page_number }}_{{ $item->column_number }}" class="w3-modal">
                <div class="w3-modal-content w3-animate-zoom" style="min-width: 90%;min-height: 90%;">
                    <div class="w3-container w3-padding-24"> <span onclick="document.getElementById('{{ $item->page_number }}_{{ $item->column_number }}').style.display='none'" class="w3-button w3-display-topright w3-xxlarge">&times;</span> <br /><br />
                        ...
                        <iframe src="{{ route('column_view', ['date' => $item->date,'page_number' => $item->page_number, 'column_number' => $item->column_number]) }}" width="100%" frameborder="0" allowfullscreen>
